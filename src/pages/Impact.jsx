  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-white p-8 pb-32">
      <div className="max-w-7xl mx-auto animate-in fade-in zoom-in duration-700">
        ...
        <header className="mb-16 pt-10 text-center md:text-left border-b border-white/5 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/5 border border-green-500/20 p-10 rounded-[2.5rem] backdrop-blur-xl relative overflow-hidden group">
            <div className="absolute -right-4 -top-4 text-7xl opacity-10 group-hover:scale-125 transition-transform">🌱</div>
            <p className="text-green-400 font-black uppercase text-[10px] tracking-widest mb-2">CO₂ Evitado (ODS 13)</p>
            <h4 className="text-6xl font-black tracking-tighter">{metricas.co2}<span className="text-xl text-green-500/50 ml-2">kg</span></h4>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] backdrop-blur-xl relative overflow-hidden group">
            ...
            <h4 className="text-6xl font-black tracking-tighter text-white">{metricas.activos}</h4>
          </div>

          <div className="bg-white/5 border border-blue-500/20 p-10 rounded-[2.5rem] backdrop-blur-xl relative overflow-hidden group">
            <div className="absolute -right-4 -top-4 text-7xl opacity-10 group-hover:scale-125 transition-transform">💰</div>
            <p className="text-blue-400 font-black uppercase text-[10px] tracking-widest mb-2">Eficiencia Económica (ODS 12)</p>
            <h4 className="text-6xl font-black tracking-tighter text-white">${metricas.ahorro}</h4>
          </div>
        </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topActivosData}>
                  ...
                  <Tooltip 
                    ...
                    contentStyle={{backgroundColor: '#161B28', borderRadius: '1rem', border: '1px solid rgba(255,255,255,0.1)', color: '#fff'}}
                  />
        ...
        <footer className="mt-20 bg-white/5 border border-white/10 p-12 rounded-[3.5rem] text-center">
          ...
          <p className="text-slate-400 text-sm max-w-4xl mx-auto leading-relaxed font-medium">
            Cada activo compartido en <strong>ShareHub</strong> evita la extracción de materias primas y energía de fabricación. 
            A través de la virtualización, extendemos la vida útil de los objetos y reducimos directamente 
            la huella de carbono bajo los estándares del modelo <strong>ReSOLVE</strong> [cite: 2026-03-01].
          </p>
        </footer>
      </div>
    </div>
